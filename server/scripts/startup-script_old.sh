#!/usr/bin/env bash
#git --version # improvement by tripleee
#GIT_IS_AVAILABLE=$?
## ...
#if [[ ${GIT_IS_AVAILABLE} -eq 0 ]]
#then
# echo ${GIT_IS_AVAILABLE} + "Hello"
#else
# echo "Not installed"
#fi
#
...
export HOME=/root
sudo git clone https://quasardev:Shanu%4045@gitlab.com/quasardev/apibucket.git /opt/apibucket
